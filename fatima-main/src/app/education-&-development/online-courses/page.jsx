      ...
      <div className="bg-white">
        ...
        <div className="w-full md:w-2/3 space-y-6">
          ...
          <p className="text-gray-700 text-lg">
            Are you ready to take your knowledge of life and medical sciences to
            the next level? Our Online Courses in Life and Medical Sciences are
            designed to provide flexible, comprehensive learning experiences for
            professionals and enthusiasts alike.
          </p>

          <p className="text-gray-700 text-lg">
            Whether you're exploring biology, medicine, bioinformatics, or
            biotechnology, we offer a wide range of courses to suit your
            interests and career goals.
          </p>

          <p className="text-gray-700 text-lg">
            Our courses are crafted to be accessible to learners at all stages
            of their journey, from beginners to seasoned professionals. With
            expert instructors and cutting-edge content, you’ll gain the skills
            and knowledge needed to make an impact in the ever-evolving world of
            life sciences.
          </p>

          <p className="text-gray-700 text-lg">
            Join a community of like-minded learners and engage in a dynamic
            online learning experience that’s tailored to your schedule.
          </p>
        </div>
      </div>
