      ...
      <div className="px-4 py-16 max-w-6xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="w-full md:w-1/2 space-y-5 text-black text-lg">
            <p>
              Helix Biogen Institute offers a cutting-edge Industrial Training
              Program aimed at students and graduates of biotechnology,
              biochemistry, microbiology, and related life sciences disciplines.
            </p>
            <p>
              Participants gain hands-on experience with modern lab equipment,
              industry protocols, and real-time research practices that align
              with global biotechnology standards.
            </p>
          </div>
        </div>
        ...
        <div className="text-black text-lg space-y-5">
          <p>
            The training is supervised by seasoned researchers and includes
            modules such as:
          </p>
          ...
          <p>
            Graduates of the Industrial Training Program leave with both
            technical proficiency and the confidence to pursue careers in
