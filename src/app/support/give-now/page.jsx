...
export default function GiveNowPage() {
  ...
  return (
    <main className="bg-grey-100 text-white min-h-screen">
      ...
      <section className="max-w-3xl bg-green-100 mx-auto px-6 py-12 my-10 text-center">
   ...
   <div className="max-w-3xl mx-auto bg-gray-100 text-gray-800 shadow-md rounded-md overflow-hidden my-12">
